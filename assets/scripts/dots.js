...
class Dots{
  constructor(id, options){
    ...
    this.wind.numParticles = this.particles;
  ...
  setColors(colors){
    ...
    this.wind.setColorRamp(colorData)
  }

  setTerrain(terrain){
    if(this.terrains.has(terrain)){
      this.wind.setTerrain(this.terrains.get(terrain))
    }
    else {
      const windImage = new Image();
      windImage.src = terrain;
      let terrains = this.terrains;
      let wind = this.wind;
      let cb = () => this.terrainReady = true;
      windImage.onload = function() {
        createImageBitmap(this).then(res => {
          terrains.set(terrain, res);
          wind.setTerrain(res);
          cb();
        });
      };
  ...
  setParticles(num){
    this.wind.numParticles = num;
  }

  setSpeed(num){
    this.wind.setSpeed(num);
  }
  ...
  setDropRate(num){
    this.wind.setDropRate(num)
  }

  setDropRateBump(num){
    this.wind.setDropRateBump(num)
  }

  setFadeOpacity(num){
    this.wind.setFadeOpacity(num)
  }
}
...
var WindGL = function WindGL(gl) {
    ...
    this.speedFactor = 0.5; // how fast the particles move
...
WindGL.prototype.setColorRamp = function setColorRamp (colors) {
    ...
    this.colorRampTexture = createTexture(this.gl, this.gl.LINEAR, colors, 4, 4);
};
...
WindGL.prototype.setTerrain = function setTerrain(image) {
...
WindGL.prototype.setSpeed = function setSpeed(factor) {
  this.speedFactor = factor;
};

WindGL.prototype.setDropRate = function setDropRate(rate) {
  this.dropRate = rate;
};
WindGL.prototype.setDropRateBump = function setDropRateBump(rate) {
  this.dropRateBump = rate;
};
WindGL.prototype.setFadeOpacity = function setFadeOpacity(opacity) {
